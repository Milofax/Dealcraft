...
public class ConfidenceSearchTests
{
    ...
    {
        BestOffer best = ConfidenceSearch.Best(Curve(
            (0.5f, 200f, 0.5f),
            (0.9f, 120f, 0.9f)));
    ...
    {
        BestOffer best = ConfidenceSearch.Best(Curve((0.9f, 120f, 0.83f)));
    ...
    {
        Assert.False(ConfidenceSearch.Best(System.Array.Empty<ConfidenceAttempt>()).Found);
    }
