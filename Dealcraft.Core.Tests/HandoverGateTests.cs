...
public class HandoverGateTests
{
    ...
    /// of a player. <c>Customer.IsAtDealLocation()</c> has
    /// two call sites in the game and both are inside
    ...
    /// the project notes; what went is the mod holding a distance at
