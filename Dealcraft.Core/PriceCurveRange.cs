...
/// <c>ProductManager.RpcLogic___SetPrice</c> (RVA <c>0x7FE9C0</c>) clamps every
/// price that is ever written between the floats at <c>0x182dffb44</c>
/// (<c>1.0</c>, loaded at <c>0x1807fea79</c>) and <c>0x182e00c18</c>
/// (<c>999.0</c>, loaded at <c>0x1807fea86</c>) and rounds to a whole dollar.
...
public readonly struct PriceCurveRange
{
    ...
    /// to (<c>RpcLogic___SetPrice</c>, RVA <c>0x7FE9C0</c>), so a finer grid
