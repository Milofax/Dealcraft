...
/// <summary>
/// What <c>docs/handover-truth.md</c> says a handover should have paid.
/// </summary>
/// <remarks>
/// <para>
...
/// disassembly it came from needs re-reading — that is the outcome the ledger
/// is built to make possible, not a failure of it.
/// </para>
/// <para>
/// Every constant below was read out of <c>GameAssembly.dll</c> rather than
/// remembered; the addresses are in <c>docs/handover-truth.md</c>. No value here
...
{
    /// <summary>Curfew and rain each pay a fifth of the payment. Read at <c>0x182e00704</c>.</summary>
    ...
    /// <summary>Dollars per extra unit, flat. Read as four bytes at <c>0x182dffb54</c>.</summary>
    public const float GenerosityPerUnit = 10f;

    /// <summary>
    /// The Generosity Bonus is not built at all unless the delivery scores at
    /// least this. Read at <c>0x182dffcc4</c>.
    /// </summary>
    public const float GenerositySatisfactionGate = 0.99f;

    /// <summary>The exceeded-quality rate. Read at <c>0x182e00828</c>.</summary>
    public const float QualityRate = 0.15f;

    /// <summary>
    /// What the tier difference is scaled by <b>on the gate's side of the
    /// comparison only</b> — <c>xmm11</c> at <c>0x1806af59c</c>, read at
    /// <c>0x182e00704</c>. It was once believed to scale the payout as well,
    ...
    /// <summary>Quick delivery pays a tenth. Read at <c>0x182e0071c</c>.</summary>
