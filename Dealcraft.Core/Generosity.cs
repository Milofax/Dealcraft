...
/// readings in the project notes settle it between them.
/// </para>
/// <para>
/// <b>The bonus is flat.</b> <c>(delivered − requested) × 10</c>, in dollars,
/// read at. Not a share of the payment.
/// </para>
/// <para>
...
///, which is not one either. So every
...
/// Generosity Bonus at exactly the <c>$10</c> a unit the reading reads —
/// three extra units paid <c>$30</c> on the row that settled it
///. Every figure here scales with
