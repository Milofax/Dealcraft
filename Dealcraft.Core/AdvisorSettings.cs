...
public sealed class AdvisorSettings
{
    ...
    /// for. Off, so a fresh install delivers exactly the grade that was ordered
    /// and the owner's best product is never spent at a lower grade's price.
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    public bool MayUseAHigherGrade { get; set; }
