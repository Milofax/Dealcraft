...
/// <c>docs/counteroffer-truth.md</c>. One rung at one quantity is one bisection
...
public static class NegotiationSearch
{
    ...
    /// generated from that same number (<c>docs/listed-price-truth.md</c>), so a
        ...
        Func<int, float, float> chance)
    {
        ...
        BestOffer best = Searched(plan, limits, floorPerUnit, Ask, out CurveChoice recommendation);
        ...
        out CurveChoice chosen)
    {
        ...
        BestOffer best = ConfidenceSearch.Best(tried);
