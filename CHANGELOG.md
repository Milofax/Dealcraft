...
- **The settings page could sit over the app's heading.** It measured where to
  start while the app was still shut, found nothing with a size in it — nothing
  does, while it is shut — and treated that as the answer rather than as
  something to wait for. A shut app is now a wait, and the log tells the two
  cases apart: nothing to measure *while shut* and nothing to measure *while
  open* are different problems and used to produce the same line.
