...
/// rather than writing it. So the automation and the player are
...
internal static class CounterofferControls
{
    ...
    /// <c>CounterofferInterface.ChangeQuantity(float)</c> is the
    ...
    /// <c>Send()</c> re-parses the field rather than reading the
