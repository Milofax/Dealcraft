...
/// (RVA <c>0x6AF000</c>) and offered
/// <c>RpcLogic___ProcessHandoverClient_2441224929</c> (RVA <c>0x6B2510</c>) as
/// the fallback. Both were read out of <c>GameAssembly.dll</c> with
/// <c>tools/native-truth/read-method.py</c> before anything was patched, and
...
/// and <c>SendObserversRpc</c>. The RVA index gives the same address
/// <c>0x6AF000</c> two names — the method and
...
/// <c>SendObserversRpc</c> at <c>0x180563530</c> directly, and its 4,171 bytes
/// contain no call to <c>0x1806af000</c> at all. A Harmony postfix there would
...
/// field at <c>+0x140</c>, loaded straight into the call at <c>0x1806afc43</c>,
...
/// (RVA <c>0x6B25F0</c>), the second reading.</b> It carries
...
/// <c>RpcReader___Server_ProcessHandoverServerSide</c> at <c>0x1806b4fef</c>,
