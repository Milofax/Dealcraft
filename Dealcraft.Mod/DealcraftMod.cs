...
[assembly: MelonInfo(typeof(Dealcraft.DealcraftMod), "Dealcraft", "1.2.0", "Milofax", null)]
...
public sealed class DealcraftMod : MelonMod
{
    ...
    private void Announce()
    {
        ...
        LoggerInstance.Msg(
            ...
            // Which build this is, on the line everybody quotes when something
            // is wrong. A bug report then carries the answer without anyone
